...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "Privacy Policy - Mugizh Clothings";
  }, []);
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                At Mugizh Clothings ("we," "our," or "us"), we respect your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, make a purchase, or interact with our services.
              </p>
            </section>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
                    ...
                    <li>Billing and shipping addresses with pin code</li>
                    <li>Payment information (processed securely through Razorpay/third-party providers)</li>
