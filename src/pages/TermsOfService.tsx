...
const TermsOfService = () => {
  useEffect(() => {
    document.title = "Terms of Service - Mugizh Clothings";
  }, []);
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using the Mugizh Clothings website and services, you accept and agree to be bound by the terms and provision of this agreement. These Terms of Service govern your use of our website, products, and services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Permission is granted to temporarily download one copy of the materials on Mugizh Clothings's website for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
              </p>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Payment is due at the time of purchase. We use secure third-party payment gateways (such as Razorpay) to process payments.
                    We accept major credit cards, debit cards, UPI, and other payment methods as displayed during checkout.
                    All prices are in INR (Indian Rupees) unless otherwise specified.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our clothing comes with a guarantee of quality. We ensure all products meet our high standards. Care instructions are provided with each purchase and on our website.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content on this website, including but not limited to text, graphics, logos, images, and software, is the property of Mugizh Clothings and is protected by copyright, trademark, and other intellectual property laws. Unauthorized use is prohibited.
              </p>
            </section>
